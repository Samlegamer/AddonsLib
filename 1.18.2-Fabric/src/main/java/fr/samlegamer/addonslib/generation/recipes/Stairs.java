...
class Stairs extends AbstractType {
    ...
    public Stairs(FabricDataGenerator output, String modid, String originalMod)
    {
        super(output, modid, originalMod, id);
    }

    private void wood_variants(Consumer<RecipeJsonProvider> consumer, String mat, Block log, Block fence, Block slab, Block stripped_log)
    {
