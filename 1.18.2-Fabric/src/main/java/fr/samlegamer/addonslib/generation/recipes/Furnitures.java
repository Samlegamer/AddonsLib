...
class Furnitures extends AbstractType {
    ...
    public Furnitures(FabricDataGenerator output, String modid, String originalMod)
    {
        super(output, modid, originalMod, id);
    }

    private void wood_variants(Consumer<RecipeJsonProvider> consumer, String mat, Block log, Block slab, Block fence, boolean isStripped)
    {
