...
class Trapdoors extends AbstractType {
    ...
    public Trapdoors(FabricDataGenerator output, String modid, String originalMod)
    {
        super(output, modid, originalMod, id);
    }

    private void trapdoor_variant(Consumer<RecipeJsonProvider> consumer, Block door_var, Block planks, Item print)
    {
    ...
    private void other_traps(Consumer<RecipeJsonProvider> consumer, String mat, Block log, Block planks, Block slab)
    {
