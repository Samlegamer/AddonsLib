...
class Paths extends AbstractType {
    ...
    public Paths(FabricDataGenerator output, String modid, String originalMod)
    {
        super(output, modid, originalMod, id);
    }

    private void wood_variants(Consumer<RecipeJsonProvider> consumer, String mat, Block planks, Block slab)
    {
