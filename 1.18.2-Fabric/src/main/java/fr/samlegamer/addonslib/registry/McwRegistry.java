                    ...
                    if(isModLoaded)
                    {
                        if(isBlockDefaultState("1.17.1", reflectedLocation)) {
                            ...
                            if (isFence(reflectedLocation)) {
                                RegistryEntryReferences.registryEntry(MODID, id, new FenceBlock(prop), tab, true, isModBaseLoaded);
                                ...
                                RegistryEntryReferences.registryEntry(MODID, id, new TrapdoorBlock(prop), tab, true, isModBaseLoaded);
                            } else if (isDoor(id)) {
                        ...
                        RegistryEntryReferences.registryEntry(MODID, id, new Block(prop), tab, false, isModBaseLoaded);
                    }
                }
            }
        }
