...
public class APIRenderTypes
{
    ...
    {
        initAllWood(MODID, WOOD, ChunkSectionLayer.CUTOUT, type);
    }

    public static void initAllWood(String MODID, List<String> WOOD, ChunkSectionLayer renderSet, ModType... type)
    {
    ...
    {
        initAllLeave(MODID, LEAVE, ChunkSectionLayer.CUTOUT);
    }

    public static void initAllLeave(String MODID, List<String> LEAVE, ChunkSectionLayer renderSet)
    {
        List<Block> renders = new ArrayList<>();
    ...
    {
        initAllStone(MODID, STONE, ChunkSectionLayer.CUTOUT, type);
    }

    public static void initAllStone(String MODID, List<String> STONE, ChunkSectionLayer renderSet, ModType... type)
    {
        List<Block> renders = new ArrayList<>();
