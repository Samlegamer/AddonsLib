...
{	
	...
	{
		Block remapped = ForgeRegistries.BLOCKS.getValue(Identifier.fromNamespaceAndPath(newModid, nameNew));
	...
	{
		Item remapped = ForgeRegistries.ITEMS.getValue(Identifier.fromNamespaceAndPath(newModid, nameNew));
