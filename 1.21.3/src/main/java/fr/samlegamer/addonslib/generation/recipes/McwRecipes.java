...
{
    protected McwRecipes(HolderLookup.Provider p_361709_, RecipeOutput p_365321_) {
    ...
    protected void recipeShapelessWith1Item(RecipeOutput output, ItemLike planks, ItemLike result, int count, ItemLike firstItem, int required, String group, String originalMod, String mcwMod)
    {
        ConditionalRecipe.builder()
                .condition(new AndCondition(List.of(new ModLoadedCondition(mcwMod), new ModLoadedCondition(originalMod))))
                ...
                .save(output, Finder.getRLOfItem(result.asItem()));
    }
    ...
    protected void recipeShapelessWith1ItemRecycle(RecipeOutput output, ItemLike planks, ItemLike result, int count, ItemLike firstItem, int required, String group, String originalMod, String mcwMod)
    {
        ConditionalRecipe.builder()
                ...
                .recipe(shapeless(RecipeCategory.BUILDING_BLOCKS, result, count)
                        ...
                        .group(group)
                        .unlockedBy(getHasName(planks), has(planks))::save)
                .save(output, ResourceLocation.fromNamespaceAndPath(Finder.getModidOfItem(result.asItem()), Finder.getIdOfItem(result.asItem()) + "_recycle"));
    }
    ...
    protected void recipeStonecutter(RecipeOutput output, ItemLike result, ItemLike firstItem, String originalMod, String mcwMod)
    {
        ...
        ConditionalRecipe.builder()
                .condition(new AndCondition(List.of(new ModLoadedCondition(mcwMod), new ModLoadedCondition(originalMod))))
                .recipe(c -> SingleItemRecipeBuilder.stonecutting(Ingredient.of(firstItem), RecipeCategory.BUILDING_BLOCKS, result)
                        .unlockedBy(getHasName(firstItem), has(firstItem)).save(c, recipeId))
