			...
			for(String i : set)
			{
				try {
				    if (AddonsLib.isLoaded(modid))
				    {
				    	...
				    	registryEntry(MODID, i+"_barn_door", new DoorBlock(DOOR_WOOD, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_barn_glass_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_modern_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_cottage_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_classic_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_beach_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_paper_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_four_panel_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_tropical_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_glass_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_stable_door", stable_door);
				    	registryEntry(MODID, i+"_stable_head_door", stable_head_door);
				    	registryEntry(MODID, i+"_western_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_mystic_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_nether_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_swamp_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_bamboo_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_bark_glass_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_waffle_door", new DoorBlock(JAPAN, BlockSetType.OAK));
						registryEntry(MODID, i+"_whispering_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    }
				    else
				    {
				    	registryEntry(MODID, i+"_japanese_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_japanese2_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_barn_door", new DoorBlock(DOOR_WOOD, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_barn_glass_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_modern_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_cottage_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	...
				    	registryEntry(MODID, i+"_tropical_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_glass_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_stable_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_stable_head_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_western_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_mystic_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_nether_door", new DoorBlock(JAPAN, BlockSetType.OAK));
				    	registryEntry(MODID, i+"_swamp_door", new DoorBlock(JAPAN, BlockSetType.OAK));
