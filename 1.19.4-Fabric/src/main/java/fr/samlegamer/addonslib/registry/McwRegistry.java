                    ...
                    if(isModLoaded)
                    {
                        if(isBlockDefaultState("1.18.2Fabric", reflectedLocation)) {
                            ...
                            if (isFence(reflectedLocation)) {
                                ...
                                RegistryEntryReferences.registryEntry(MODID, id, new FenceGateBlock(prop, woodType));
                            } else if (isTrapdoor(id)) {
                                RegistryEntryReferences.registryEntry(MODID, id, new TrapdoorBlock(prop, blockSetType));
                            } else if (isDoor(id)) {
                                RegistryEntryReferences.registryEntry(MODID, id, new DoorBlock(prop, blockSetType));
                            } else {
