...
abstract class AbstractType {
    ...
    public AbstractType(PackOutput pOutput, CompletableFuture<HolderLookup.Provider> pRegistries, String modid, String originalMod, String id)
    {
        this.modid = modid;
        this.originalMod = originalMod;
        this.mcwRecipes = new McwRecipes(pOutput, pRegistries, modid, id, originalMod);
    }
