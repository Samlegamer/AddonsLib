...
class Windows extends AbstractType {
    ...
    private void wood_variants(RecipeGenerator generator, RecipeExporter exporter, String mat, Block log, Block planks, Block slab, Block trapdoor, Block stripped_log)
    {
        ...
        mcwRecipes.mkRpW2Items(generator, exporter, log, new String[]{" A ", "ABA", " A "}, window, 4, window_base, log, "windows");
        mcwRecipes.mkRpW2Items(generator, exporter, log, new String[]{" A ", "ABA", " A "}, plank_window, 4, window_base, planks, "windows");
        mcwRecipes.mkRpW2Items(generator, exporter, log, new String[]{"AAA", "ABA", "AAA"}, window2, 8, window_half_bar_base, log, "windows_two");
        mcwRecipes.mkRpW2Items(generator, exporter, log, new String[]{"AAA", "ABA", "AAA"}, plank_window2, 8, window_half_bar_base, planks, "windows_two");
        mcwRecipes.mkRpW2Items(generator, exporter, log, new String[]{"AAA", "ABA", "AAA"}, pane_window, 8, window_base, log, "windows_pane");
        mcwRecipes.mkRpW2Items(generator, exporter, log, new String[]{"AAA", "ABA", "AAA"}, plank_pane_window, 8, window_base, planks, "windows_pane");
        mcwRecipes.mkRpW2Items(generator, exporter, log, new String[]{"AAA", "ABA", "AAA"}, four_window, 8, window_centre_bar_base, log, "windows_four");
        mcwRecipes.mkRpW2Items(generator, exporter, log, new String[]{"AAA", "ABA", "AAA"}, plank_four_window, 8, window_centre_bar_base, planks, "windows_four");
        mcwRecipes.mkRpW2Items(generator, exporter, log, new String[]{" A ", "ABA", " A "}, stripped_log_window, 4, window_base, stripped_log, "windows");
        mcwRecipes.mkRpW2Items(generator, exporter, log, new String[]{"AAA", "ABA", "AAA"}, stripped_pane_window, 8, window_base, stripped_log, "windows_pane");
        mcwRecipes.mkRpW2Items(generator, exporter, log, new String[]{"AAA", "ABA", "AAA"}, stripped_log_window2, 8, window_half_bar_base, stripped_log, "windows_two");
        mcwRecipes.mkRpW2Items(generator, exporter, log, new String[]{"AAA", "ABA", "AAA"}, stripped_log_four_window, 8, window_centre_bar_base, stripped_log, "windows_four");
    }
    ...
    public void buildWood(RecipeGenerator generator, RecipeExporter exporter, List<String> MAT, List<McwWoodMat> woodMat)
    {
        if(MAT.size() == woodMat.size()) {
            for (int i = 0; i < MAT.size(); i++) {
                ...
                wood_variants(generator, exporter, MAT.get(i), log, planks, slab, trapdoor, stripped_log);
            }
        }
    }
