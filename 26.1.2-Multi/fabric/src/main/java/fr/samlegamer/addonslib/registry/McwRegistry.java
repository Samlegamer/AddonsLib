        ...
        for(ModType mod : type)
        {
            for(Map.Entry<String, SoundType> map : orderedMap.entrySet())
            {
                ...
                for(BlockId blockId : mcwBlockIdBase.blocks())
                {
                    ...
                    BlockBehaviour.Properties prop = McwProperties.getWoodProperties(mat, mod).sound(soundType).setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(MODID, id)));
    ...
    public static void setRegistriesLeave(String MODID, Map<String, SoundType> stringSoundTypeMap)
    {
        ...
        for(BlockId blockId : mcwBlockIdBase.blocks())
        {
            for(Map.Entry<String, SoundType> map : orderedMap.entrySet())
            {
                ...
                prop = McwProperties.getLeaveProperties().sound(soundType).setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(MODID, id)));
        ...
        for(ModType mod : type)
        {
            for(Map.Entry<String, SoundType> map : orderedMap.entrySet())
            {
                ...
                for(BlockId blockId : mcwBlockIdBase.blocks())
                {
                    ...
                    prop = McwProperties.getStoneProperties(mod).sound(soundType).setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(MODID, id)));
