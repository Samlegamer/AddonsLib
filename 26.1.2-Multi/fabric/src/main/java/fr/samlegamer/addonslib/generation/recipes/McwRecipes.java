...
public abstract class McwRecipes extends FabricRecipeProvider implements IRecipes {
    ...
    public McwRecipes(FabricPackOutput fabricDataOutput, CompletableFuture<HolderLookup.Provider> registriesFuture, HolderLookup.Provider provider, RecipeOutput recipeOutput) {
