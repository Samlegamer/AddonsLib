...
class Fences extends AbstractType {
    ...
    private void hedge(RecipeExporter exporter, Block hedge, Block leave)
    {
        mcwRecipes.mkRpW1Item(exporter, leave, new String[]{"AA", "AA"}, hedge, 4, leave, "hedge");
    }

    private void stone_variants(RecipeExporter exporter, String mat, Block stone, Block smoothStone)
    {
