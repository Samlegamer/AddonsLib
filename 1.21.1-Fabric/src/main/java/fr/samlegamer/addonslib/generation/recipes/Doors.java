...
class Doors extends AbstractType {
    ...
    private void door_variant(RecipeExporter exporter, Block door_var, Block planks, Item print)
    {
    ...
    private void other_door(RecipeExporter exporter, String mat, Block log, Block planks, Block slab)
    {
