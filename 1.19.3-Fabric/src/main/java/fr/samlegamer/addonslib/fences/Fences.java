			...
			{				
				try {
				    ...
				    else
				    {
				        ...
				        registryEntry(MODID, i + "_highley_gate", new FenceGateBlock(WOOD, SoundEvents.BLOCK_FENCE_GATE_CLOSE, SoundEvents.BLOCK_FENCE_GATE_OPEN), tab, modLoaded);
				        registryEntry(MODID, i + "_pyramid_gate", new FenceGateBlock(WOOD, SoundEvents.BLOCK_FENCE_GATE_CLOSE, SoundEvents.BLOCK_FENCE_GATE_OPEN), tab, modLoaded);
				    }
				} catch (Exception e) {
				    e.printStackTrace();
				}
			...
			for(String i : rock)
			{
				try {
					...
					else
		            {
						...
						registryEntry(MODID, i+"_railing_gate", new FenceGateBlock(STONE, SoundEvents.BLOCK_FENCE_GATE_CLOSE, SoundEvents.BLOCK_FENCE_GATE_OPEN), tab, modLoaded);
