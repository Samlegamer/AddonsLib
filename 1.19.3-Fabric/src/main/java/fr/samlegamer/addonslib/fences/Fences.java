		...
		for (String i : set) {
			try {
				if (AddonsLib.isLoaded(modid)) {
					...
					final Block highley_gate = new FenceGateBlock(WOOD, SoundEvents.BLOCK_FENCE_GATE_CLOSE, SoundEvents.BLOCK_FENCE_GATE_OPEN);
					final Block pyramid_gate = new FenceGateBlock(WOOD, SoundEvents.BLOCK_FENCE_GATE_CLOSE, SoundEvents.BLOCK_FENCE_GATE_OPEN);
					...
					registryEntry(MODID, i + "_highley_gate", new FenceGateBlock(WOOD, SoundEvents.BLOCK_FENCE_GATE_CLOSE, SoundEvents.BLOCK_FENCE_GATE_OPEN));
					registryEntry(MODID, i + "_pyramid_gate", new FenceGateBlock(WOOD, SoundEvents.BLOCK_FENCE_GATE_CLOSE, SoundEvents.BLOCK_FENCE_GATE_OPEN));
					registryEntry(MODID, i + "_curved_gate", new FenceGateBlock(WOOD, SoundEvents.BLOCK_FENCE_GATE_CLOSE, SoundEvents.BLOCK_FENCE_GATE_OPEN));
				}
			} catch (Exception e) {
		...
		for (String i : rock) {
			try {
				if (AddonsLib.isLoaded(modid)) {
					...
					final Block railing_gate = new FenceGateBlock(STONE, SoundEvents.BLOCK_FENCE_GATE_CLOSE, SoundEvents.BLOCK_FENCE_GATE_OPEN);
					...
					registryEntry(MODID, i + "_railing_gate", new FenceGateBlock(STONE, SoundEvents.BLOCK_FENCE_GATE_CLOSE, SoundEvents.BLOCK_FENCE_GATE_OPEN));
