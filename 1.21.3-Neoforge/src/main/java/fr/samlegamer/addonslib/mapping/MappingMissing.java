...
public class MappingMissing
{
	...
	{
		ResourceLocation old = ResourceLocation.fromNamespaceAndPath(oldModid, nameMissing);
		ResourceLocation remapped = ResourceLocation.fromNamespaceAndPath(newModid, nameNew);
