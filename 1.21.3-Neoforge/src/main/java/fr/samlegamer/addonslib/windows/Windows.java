					...
					switch (relectedLocation)
					{
						case "Parapet":
							CreateBlockReferences.createBlock(id, registryName ->
											Registration.getBlocksField(relectedLocation, PARAPET.setId(ResourceKey.create(Registries.BLOCK, registryName))),
									block, item);
							break;
						case "Blinds":
							CreateBlockReferences.createBlock(id, registryName ->
											Registration.getBlocksField(relectedLocation, BLINDS.setId(ResourceKey.create(Registries.BLOCK, registryName))),
									block, item);
							break;
						case "Shutter":
							CreateBlockReferences.createBlock(id, registryName ->
											Registration.getBlocksField(relectedLocation, SHUTTER.setId(ResourceKey.create(Registries.BLOCK, registryName))),
									block, item);
							break;
						case "CurtainRod":
							CreateBlockReferences.createBlock(id, registryName ->
											Registration.getBlocksField(relectedLocation, ROD.setId(ResourceKey.create(Registries.BLOCK, registryName))),
									block, item);
							break;
						default:
							CreateBlockReferences.createBlock(id, registryName ->
											Registration.getBlocksField(relectedLocation, WOOD.setId(ResourceKey.create(Registries.BLOCK, registryName))),
									block, item);
							break;
					}
				}
