...
public abstract class RecipesUtils extends RecipeProvider
{
    ...
    protected RecipesUtils(HolderLookup.Provider provider, RecipeOutput recipeOutput, IRecipes iRecipes) {
    ...
    public void registerMcwWood(RecipeOutput output, String modid, String originalMod, List<String> MAT, List<McwWoodMat<Block>> woodMats, ModType... modType)
    {
    ...
    public void registerMcwStone(RecipeOutput output, String modid, String originalMod, List<String> MAT, List<McwStoneMat<Block>> stoneMats, ModType... modType)
    {
        for(ModType mod : modType)
        {
    ...
    public void registerMcwHedge(RecipeOutput output, String modid, String originalMod, List<String> MAT, List<Block> blockLeave)
    {
    ...
    public DoubleObject<RecipeBuilder, Identifier> doubleObjectShapeless(ItemLike planks, ItemLike result, int count, ItemLike firstItem, int required, String group)
    {
        Identifier recipeId = Finder.getRLOfItem(result.asItem());
        ShapelessRecipeBuilder shapelessRecipeBuilder = shapeless(RecipeCategory.BUILDING_BLOCKS, result, count)
    ...
    public DoubleObject<RecipeBuilder, Identifier> doubleObjectShapelessRecycle(ItemLike planks, ItemLike result, int count, ItemLike firstItem, int required, String group)
    {
        Identifier recipeId = Identifier.fromNamespaceAndPath(Finder.getModidOfItem(result.asItem()), Finder.getIdOfItem(result.asItem()) + "_recycle");
        ShapelessRecipeBuilder shapelessRecipeBuilder = shapeless(RecipeCategory.BUILDING_BLOCKS, result, count)
                        .requires(firstItem, required)
                        .group(group)
                        .unlockedBy(getHasName(planks), has(planks));
    ...
    public DoubleObject<RecipeBuilder, Identifier> doubleObjectShapedWithItems(ItemLike planks, String[] pattern, ItemLike result, int count, String group, ItemLike... items)
    {
        Identifier recipeId = Finder.getRLOfItem(result.asItem());
        ShapedRecipeBuilder shapedRecipeJsonBuilder = shaped(RecipeCategory.BUILDING_BLOCKS, result, count);
    ...
    public DoubleObject<RecipeBuilder, String> doubleObjectStonecutter(ItemLike result, ItemLike firstItem)
    {
        ...
        SingleItemRecipeBuilder builder = SingleItemRecipeBuilder.stonecutting(Ingredient.of(firstItem), RecipeCategory.BUILDING_BLOCKS, result, 1)
