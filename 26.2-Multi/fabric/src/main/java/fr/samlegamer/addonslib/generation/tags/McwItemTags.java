...
public abstract class McwItemTags extends FabricTagsProvider.ItemTagsProvider implements ITag
{
    public McwItemTags(FabricPackOutput output, CompletableFuture<HolderLookup.Provider> completableFuture) {
