...
public class IconRandomFabric extends IconRandom
{
    ...
    Block trapdoorsIcon, Block pathsIcon, Block stairsIcon, ModType... types) {
        return buildIcon(new ModListFabric(), roofsIcon, fencesIcon, furnituresIcon, bridgesIcon, windowsIcon, doorsIcon, trapdoorsIcon, pathsIcon, stairsIcon, types);
    }
}