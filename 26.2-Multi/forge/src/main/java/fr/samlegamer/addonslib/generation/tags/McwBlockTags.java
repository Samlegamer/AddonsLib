...
public abstract class McwBlockTags extends TagsProvider<Block> implements ITag
{
    protected McwBlockTags(PackOutput output, ResourceKey<? extends Registry<Block>> registryKey, CompletableFuture<HolderLookup.Provider> lookupProvider, String modId, @Nullable ExistingFileHelper existingFileHelper) {
