...
public class Finder
{
	...
	{
		return BuiltInRegistries.BLOCK.getValue(Identifier.fromNamespaceAndPath(MODID, nameBlock));
	}

	public static Block findBlock(String MODIDNameBlock)
	{
		return BuiltInRegistries.BLOCK.getValue(Identifier.parse(MODIDNameBlock));
	}

	public static Item findItem(String MODID, String nameItem)
	{
		return BuiltInRegistries.ITEM.getValue(Identifier.fromNamespaceAndPath(MODID, nameItem));
	}

	public static Item findItem(String MODIDNameItem)
	{
		return BuiltInRegistries.ITEM.getValue(Identifier.parse(MODIDNameItem));
	}

	public static BlockEntityType<?> findTileEntity(String MODID, String nameTileEntity)
	{
		return BuiltInRegistries.BLOCK_ENTITY_TYPE.getValue(Identifier.fromNamespaceAndPath(MODID, nameTileEntity));
	}
