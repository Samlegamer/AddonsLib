...
public abstract class McwBlockTags extends FabricTagProvider.BlockTagProvider
{
    ...
    public void mcwWindowsTags(String modid, List<String> WOOD)
    {
        ...
        this.valueLookupBuilder(BlockTags.AXE_MINEABLE).add(listToArray(blocksWood.stream().toList()));
        ...
        this.valueLookupBuilder(getTag(Windows.modid, "blinds")).add(getSetWithEndsWith(blocksWood, "_blinds"));
        this.valueLookupBuilder(getTag(Windows.modid, "curtain_rods")).add(getSetWithEndsWith(blocksWood, "_curtain_rod"));
        this.valueLookupBuilder(getTag(Windows.modid, "parapets")).add(getSetWithEndsWith(blocksWood, "_log_parapet"));
        this.valueLookupBuilder(getTag(Windows.modid, "shutters")).add(getSetWithEndsWith(blocksWood, "_shutter"));
        this.valueLookupBuilder(getTag(Windows.modid, "windows_four")).add(getSetWithEndsWith(blocksWood, "_four_window"));
        this.valueLookupBuilder(getTag(Windows.modid, "windows_two")).add(getSetWithEndsWith(blocksWood, "_window2"));
        this.valueLookupBuilder(getTag(Windows.modid, "windows")).add(getSetWithEndsWith(blocksWood, "_window"));
    }
    ...
    public void mcwStairsTags(String modid, List<String> WOOD)
    {
        ...
        this.valueLookupBuilder(getTag(Stairs.modid, "balconies")).add(getSetWithEndsWith(blocksWood, "_balcony"));
        this.valueLookupBuilder(getTag(Stairs.modid, "bulk_stairs")).add(getSetWithEndsWith(blocksWood, "_bulk_stairs"));
        this.valueLookupBuilder(getTag(Stairs.modid, "compact_stairs")).add(getSetWithEndsWith(blocksWood, "_compact_stairs"));
        this.valueLookupBuilder(getTag(Stairs.modid, "loft_stairs")).add(getSetWithEndsWith(blocksWood, "_loft_stairs"));
        this.valueLookupBuilder(getTag(Stairs.modid, "platforms")).add(getSetWithEndsWith(blocksWood, "_platform"));
        this.valueLookupBuilder(getTag(Stairs.modid, "railings")).add(getSetWithEndsWith(blocksWood, "_railing"));
        this.valueLookupBuilder(getTag(Stairs.modid, "skyline_stairs")).add(getSetWithEndsWith(blocksWood, "_skyline_stairs"));
        this.valueLookupBuilder(getTag(Stairs.modid, "terrace_stairs")).add(getSetWithEndsWith(blocksWood, "_terrace_stairs"));
    }
    ...
    public void mcwRoofsTags(String modid, List<String> WOOD, List<String> STONE)
    {
        ...
        this.valueLookupBuilder(BlockTags.PICKAXE_MINEABLE).add(listToArray(blocksStone.stream().toList()));
    }
    ...
    public void mcwPathsTags(String modid, List<String> WOOD)
    {
        ...
        this.valueLookupBuilder(getTag(Paths.modid, "wooden_paths")).add(listToArray(blocksWood));
    }
    ...
    public void mcwFurnituresTags(String modid, List<String> WOOD)
    {
        ...
        this.valueLookupBuilder(BlockTags.AXE_MINEABLE).add(listToArray(blocksWood.stream().toList()));
        this.valueLookupBuilder(BlockTags.ENCHANTMENT_POWER_PROVIDER).add(getSetWithContain(blocksWood, "bookshelf"));
        ...
        for(Map.Entry<String, List<String>> mapEntry : map.entrySet())
        {
            ...
            this.valueLookupBuilder(getTag(Furnitures.modid, mapEntry.getKey())).add(listToArray(blocks));
        }
    }
    ...
    public void mcwFencesTags(String modid, List<String> WOOD, List<String> LEAVE, List<String> STONE)
    {
        ...
        this.valueLookupBuilder(BlockTags.HOE_MINEABLE).add(listToArray(blocksLeave.stream().toList()));
        ...
        this.valueLookupBuilder(BlockTags.FENCE_GATES).add(highley_gates).add(pyramid_gates).add(curved_gates).add(railing_gate);
        this.valueLookupBuilder(BlockTags.FENCES).add(hedges).add(modern_wall).add(pillar_wall).add(railing_wall).add(grass_topped_wall)
        .add(picket_fences).add(stockade_fences).add(horse_fences).add(wired_fences).add(curved_gates);
        this.valueLookupBuilder(BlockTags.WALLS).add(hedges).add(grass_topped_wall);
        this.valueLookupBuilder(BlockTags.WOODEN_FENCES).add(picket_fences).add(stockade_fences).add(horse_fences).add(wired_fences).add(curved_gates);

        this.valueLookupBuilder(getTag(Fences.modid, "curved_double_gates")).add(curved_gates);
        this.valueLookupBuilder(getTag(Fences.modid, "highley_gates")).add(highley_gates);
        this.valueLookupBuilder(getTag(Fences.modid, "horse_fences")).add(horse_fences);
        this.valueLookupBuilder(getTag(Fences.modid, "picket_fences")).add(picket_fences);
        this.valueLookupBuilder(getTag(Fences.modid, "pyramid_gates")).add(pyramid_gates);
        this.valueLookupBuilder(getTag(Fences.modid, "pyramid_gates")).add(pyramid_gates);
        this.valueLookupBuilder(getTag(Fences.modid, "stockade_fences")).add(stockade_fences);
        this.valueLookupBuilder(getTag(Fences.modid, "wired_fences")).add(wired_fences);

        this.valueLookupBuilder(getTag(Fences.modid, "hedges")).add(hedges);

        this.valueLookupBuilder(getTag(Fences.modid, "grass_topped_walls")).add(grass_topped_wall);
        this.valueLookupBuilder(getTag(Fences.modid, "modern_walls")).add(modern_wall);
        this.valueLookupBuilder(getTag(Fences.modid, "pillar_walls")).add(pillar_wall);
        this.valueLookupBuilder(getTag(Fences.modid, "railing_gates")).add(railing_gate);
        this.valueLookupBuilder(getTag(Fences.modid, "railing_walls")).add(railing_wall);
    }
    ...
    public void mcwBridgesTagsWood(String modid, List<String> MAT)
    {
        ...
        this.valueLookupBuilder(getTag(Bridges.modid, "log_bridges")).add(getSetWithContain(blocksWood, "log_bridge_middle"));
        this.valueLookupBuilder(getTag(Bridges.modid, "log_stairs")).add(getSetWithContain(blocksWood, "log_bridge_stair"));
        this.valueLookupBuilder(getTag(Bridges.modid, "rail_bridges")).add(getSetWithContain(blocksWood, "rail_bridge"));
        this.valueLookupBuilder(getTag(Bridges.modid, "rope_bridges")).add(getSetWithStartsWith(blocksWood, "rope_"));
        this.valueLookupBuilder(getTag(Bridges.modid, "rope_stairs")).add(getSetWithContain(blocksWood, "rope_bridge_stair"));
        this.valueLookupBuilder(getTag(Bridges.modid, "wooden_piers")).add(getSetWithContain(blocksWood, "bridge_pier"));
    }
    ...
    public void mcwBridgesTagsStone(String modid, List<String> MAT)
    {
        ...
        this.valueLookupBuilder(BlockTags.PICKAXE_MINEABLE).add(listToArray(blocks.stream().toList()));

        this.valueLookupBuilder(getTag(Bridges.modid, "stone_bridges")).add(getSetWithEndsWith(blocks, "_bridge"));
        this.valueLookupBuilder(getTag(Bridges.modid, "stone_piers")).add(getSetWithContain(blocks, "bridge_pier"));
        this.valueLookupBuilder(getTag(Bridges.modid, "stone_stairs")).add(getSetWithContain(blocks, "bridge_stair"));
    }
    ...
    public void mcwDoorsTagsWood(String modid, List<String> MAT)
    {
        ...
        this.valueLookupBuilder(BlockTags.AXE_MINEABLE).add(listToArray(blocks.stream().toList()));

        Block[] blockArray = listToArray(blocks);
        this.valueLookupBuilder(BlockTags.WOODEN_DOORS).add(blockArray);
        ...
        for(Map.Entry<String, String> map : moddedTag.entrySet())
        {
            ...
            this.valueLookupBuilder(tag).add(blocks2);
        }
    }
    ...
    public void mcwTrapdoorsTagsWood(String modid, List<String> MAT)
    {
        ...
        Block[] blockArray = listToArray(blocks);
        this.valueLookupBuilder(BlockTags.WOODEN_TRAPDOORS).add(blockArray);
