...
public abstract class McwItemTags extends FabricTagProvider.ItemTagProvider
{
    ...
    public void mcwFencesTags(String modid, List<String> WOOD, List<String> LEAVE, List<String> STONE)
    {
        ...
        this.valueLookupBuilder(ItemTags.FENCES).add(modern_wall).add(pillar_wall).add(railing_wall)
                .add(picket_fences).add(stockade_fences).add(horse_fences).add(wired_fences).add(curved_gates);
        this.valueLookupBuilder(ItemTags.WALLS).add(hedges).add(grass_topped_wall);
        this.valueLookupBuilder(ItemTags.WOODEN_FENCES).add(picket_fences).add(stockade_fences).add(horse_fences).add(wired_fences).add(curved_gates);
    }
    ...
    public void mcwDoorsTagsWood(String modid, List<String> MAT)
    {
        ...
        this.valueLookupBuilder(ItemTags.WOODEN_DOORS).add(itemArray);
    }
    ...
    public void mcwTrapdoorsTagsWood(String modid, List<String> MAT)
    {
        ...
        Item[] itemArray = listToArray(items);
        this.valueLookupBuilder(ItemTags.WOODEN_TRAPDOORS).add(itemArray);
    }
