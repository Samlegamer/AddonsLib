...
public class CreateBlockReferences
{
    ...
    ItemGroup tab, boolean isModMcwLoaded, boolean isModBaseLoaded)
    {
    ...
    public static void createBlockWoodOpti(String Modid, String name, Block block, ItemGroup tab, boolean isModLoaded)
    {
        BlockItem itemBlock;
        Item.Properties properties = new Item.Properties();
        if(isModLoaded)
    ...
    public static void createBlockStoneOpti(String Modid, String name, Block block, ItemGroup tab, boolean isModLoaded)
    {
        BlockItem itemBlock;
        Item.Properties properties = new Item.Properties();
        if(isModLoaded)
