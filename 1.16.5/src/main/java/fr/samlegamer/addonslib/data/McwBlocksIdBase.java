...
{
    public static final McwBlockIdBase BRIDGES_WOOD_BLOCKS = new McwBlockIdBase(Bridges.modid, Arrays.asList(
    ...
    public static final McwBlockIdBase BRIDGES_STONE_BLOCKS = new McwBlockIdBase(Bridges.modid, Arrays.asList(
    ...
    public static final McwBlockIdBase DOORS_WOOD_BLOCKS = new McwBlockIdBase(Doors.modid, Arrays.asList(
    ...
    public static final McwBlockIdBase FENCES_WOOD_BLOCKS = new McwBlockIdBase(Fences.modid, Arrays.asList(
    ...
    public static final McwBlockIdBase FENCES_LEAVE_BLOCKS = new McwBlockIdBase(Fences.modid, Arrays.asList(
            new BlockId("%material%_hedge", "com.mcwfences.kikoz.objects.FenceHitbox")
    ));

    public static final McwBlockIdBase FENCES_STONE_BLOCKS = new McwBlockIdBase(Fences.modid, Arrays.asList(
    ...
    public static final McwBlockIdBase FURNITURES_WOOD_BLOCKS = new McwBlockIdBase(Furnitures.modid, Arrays.asList(
    ...
    public static final McwBlockIdBase PATHS_WOOD_BLOCKS = new McwBlockIdBase(Paths.modid, Arrays.asList(
            new BlockId("%material%_planks_path", "com.mcwpaths.kikoz.objects.FacingPathBlock")
    ));

    public static final McwBlockIdBase ROOFS_WOOD_BLOCKS = new McwBlockIdBase(Roofs.modid, Arrays.asList(
    ...
    public static final McwBlockIdBase ROOFS_STONE_BLOCKS = new McwBlockIdBase(Roofs.modid, Arrays.asList(
            new BlockId("%material%_roof", "com.mcwroofs.kikoz.objects.roofs.BaseRoof"),
            new BlockId("%material%_attic_roof", "com.mcwroofs.kikoz.objects.roofs.RoofGlass"),
            new BlockId("%material%_top_roof", "com.mcwroofs.kikoz.objects.roofs.RoofTopNew"),
            new BlockId("%material%_lower_roof", "com.mcwroofs.kikoz.objects.roofs.BaseRoof"),
    ...
    public static final McwBlockIdBase STAIRS_WOOD_BLOCKS = new McwBlockIdBase(Stairs.modid, Arrays.asList(
    ...
    public static final McwBlockIdBase TRAPDOORS_WOOD_BLOCKS = new McwBlockIdBase(Trapdoors.modid, Arrays.asList(
    ...
    public static final McwBlockIdBase WINDOWS_WOOD_BLOCKS = new McwBlockIdBase(Windows.modid, Arrays.asList(
