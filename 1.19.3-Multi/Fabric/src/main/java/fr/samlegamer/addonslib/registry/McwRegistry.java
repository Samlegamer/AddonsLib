                ...
                for(BlockId blockId : mcwBlockIdBase.blocks())
                {
                    ...
                    if(isModLoaded)
                    {
                        if(isBlockDefaultState("1.18.2Fabric", reflectedLocation)) {
                            ...
                            RegistryEntryReferences.registryEntryWood(MODID, id, Registration.getBlocksField(blockId.reflectedLocation().getFabric(), prop, SoundEvents.WOODEN_DOOR_CLOSE, SoundEvents.WOODEN_DOOR_OPEN));
                        }
                        else {
                    ...
                    if(isModLoaded)
                    {
                        if(isBlockDefaultState("1.18.2Fabric", reflectedLocation)) {
                            ...
                            if (isFence(reflectedLocation)) {
                                ...
                                RegistryEntryReferences.registryEntryStone(MODID, id,  new FenceGateBlock(prop, SoundEvents.FENCE_GATE_CLOSE, SoundEvents.FENCE_GATE_OPEN));
                            }  else {
                                RegistryEntryReferences.registryEntryStone(MODID, id,  Registration.getBlocksField(blockId.reflectedLocation().getFabric(), prop));
                            }
                        }
                    }
                    else {
