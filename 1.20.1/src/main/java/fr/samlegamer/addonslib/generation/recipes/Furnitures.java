...
class Furnitures extends AbstractType {
    ...
    public Furnitures(PackOutput packOutput, String modid, String originalMod) {
        super(packOutput, modid, originalMod, id);
    }

    private void wood_variants(Consumer<FinishedRecipe> consumer, String mat, Block log, Block slab, Block fence, boolean isStripped)
    {
