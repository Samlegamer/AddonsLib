...
class Bridges extends AbstractType {
    ...
    private void pier(Consumer<FinishedRecipe> consumer, Block pier, Block log, Block fence) {
        mcwRecipes.mkRpW2Items(consumer, log, new String[]{"ABA"}, pier, 3, log, fence, "wooden_piers");
    }

    private void log_bridge(Consumer<FinishedRecipe> consumer, Block log_bridge, Block log, Block slab, Block fence) {
        mcwRecipes.mkRpW2Items(consumer, log, new String[]{"B B", "AAA"}, log_bridge, 4, slab, fence, "log_bridges");
    }

    private void log_bridge_stair(Consumer<FinishedRecipe> consumer, Block log_bridge_stair, Block log, Block log_bridge) {
    ...
    private void rail_bridge(Consumer<FinishedRecipe> consumer, Block rail_bridge, Block log, Block slab, Block fence) {
        mcwRecipes.mkRpW2Items(consumer, log, new String[]{"B B", "BAB"}, rail_bridge, 4, slab, fence, "rail_bridges");
    }

    private void rope_bridge_stair(Consumer<FinishedRecipe> consumer, Block rope_bridge_stair, Block log, Block rope_bridge) {
    ...
    private void rope_bridge(Consumer<FinishedRecipe> consumer, Block rope_bridge, Block log, Block slab) {
