...
public class McwRecipes
{
    ...
    private static AbstractType getFromModType(ModType modType, String modid, String originalMod)
    {
        return switch (modType) {
            case BRIDGES -> new Bridges(modid, originalMod);
            case DOORS -> new Doors(modid, originalMod);
            case FENCES -> new Fences(modid, originalMod);
            case FURNITURES -> new Furnitures(modid, originalMod);
            case PATHS -> new Paths(modid, originalMod);
            case ROOFS -> new Roofs(modid, originalMod);
            case STAIRS -> new Stairs(modid, originalMod);
            case TRAPDOORS -> new Trapdoors(modid, originalMod);
            case WINDOWS -> new Windows(modid, originalMod);
            default -> null;
        };
    }

    public static void onRegisterMcwWood(ModType modType, Consumer<FinishedRecipe> consumer, String modid, String originalMod, List<String> MAT, List<McwWoodMat> woodMats)
    {
    ...
    public static void onRegisterMcwStone(ModType modType, Consumer<FinishedRecipe> consumer, String modid, String originalMod, List<String> MAT, List<McwStoneMat> stoneMats)
    {
        AbstractType abstractType = getFromModType(modType, modid, originalMod);
        if(abstractType != null)
        {
    ...
    public static void registerAllMcwWood(Consumer<FinishedRecipe> consumer, String modid, String originalMod, List<String> MAT, List<McwWoodMat> woodMats)
    {
    ...
    public static void registerAllMcwStone(Consumer<FinishedRecipe> consumer, String modid, String originalMod, List<String> MAT, List<McwStoneMat> stoneMats)
    {
    ...
    public static void registerMcwHedge(Consumer<FinishedRecipe> consumer, String modid, String originalMod, List<String> MAT, List<Block> leave)
    {
    ...
    protected void mkScW1Item(Consumer<FinishedRecipe> consumer, ItemLike result, ItemLike firstItem)
    {
        ...
        ConditionalRecipe.builder()
                ...
                .addRecipe((Consumer<FinishedRecipe> finishedRecipeConsumer) -> {
                    SingleItemRecipeBuilder.stonecutting(Ingredient.of(firstItem), result)
                            .unlockedBy("has_stone", has(firstItem))
                            .save(finishedRecipeConsumer, recipeId);
                })
                .build(consumer, new ResourceLocation(recipeId));
    }

    protected void mkRpW3Items(Consumer<FinishedRecipe> consumer, ItemLike planks, String[] pattern, ItemLike result, int count, ItemLike firstItem, ItemLike secondItem, ItemLike thirdItem, String group)
    {
        if(pattern.length == 3)
        {
    ...
    protected void mkRpW2Items(Consumer<FinishedRecipe> consumer, ItemLike planks, String[] pattern, ItemLike result, int count, ItemLike firstItem, ItemLike secondItem, String group)
    {
        if(pattern.length == 3)
        {
            ConditionalRecipe.builder().addCondition(new ModLoadedCondition(this.mcwModid)).addCondition(new ModLoadedCondition(this.originalMod)).addRecipe(
    ...
    protected void mkRpW1Item(Consumer<FinishedRecipe> consumer, ItemLike planks, String[] pattern, ItemLike result, int count, ItemLike firstItem, String group, String suffix)
    {
        ConditionalRecipe.builder().addCondition(new ModLoadedCondition(this.mcwModid)).addCondition(new ModLoadedCondition(this.originalMod)).addRecipe(
                        ShapedRecipeBuilder.shaped(result, count)
                                .pattern(pattern[0])
    ...
    protected void mkRpShapelessW1Item(Consumer<FinishedRecipe> consumer, ItemLike planks, ItemLike result, int count, ItemLike firstItem, int required, String group, String suffix)
    {
        ConditionalRecipe.builder().addCondition(new ModLoadedCondition(this.mcwModid)).addCondition(new ModLoadedCondition(this.originalMod)).addRecipe(
    ...
    protected void mkRpShapelessW1Item(Consumer<FinishedRecipe> consumer, ItemLike planks, ItemLike result, int count, ItemLike firstItem, String group, String suffix)
    {
        mkRpShapelessW1Item(consumer, planks, result, count, firstItem, 1, group, suffix);
    }

    protected void mkRpW1Item(Consumer<FinishedRecipe> consumer, ItemLike planks, String[] pattern, ItemLike result, int count, ItemLike firstItem, String group)
    {
