...
public class Finder
{
	...
	{
		return BuiltInRegistries.BLOCK.getValue(ResourceLocation.fromNamespaceAndPath(MODID, nameBlock));
	}

	public static Block findBlock(String MODIDNameBlock)
	{
		return BuiltInRegistries.BLOCK.getValue(ResourceLocation.parse(MODIDNameBlock));
	}

	public static Item findItem(String MODID, String nameItem)
	{
		return BuiltInRegistries.ITEM.getValue(ResourceLocation.fromNamespaceAndPath(MODID, nameItem));
	}

	public static Item findItem(String MODIDNameItem)
	{
		return BuiltInRegistries.ITEM.getValue(ResourceLocation.parse(MODIDNameItem));
	}

	public static BlockEntityType<?> findTileEntity(String MODID, String nameTileEntity)
	{
		return BuiltInRegistries.BLOCK_ENTITY_TYPE.getValue(ResourceLocation.fromNamespaceAndPath(MODID, nameTileEntity));
	}
