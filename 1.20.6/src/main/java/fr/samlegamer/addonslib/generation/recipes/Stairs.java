...
class Stairs extends AbstractType {
    ...
    public Stairs(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> registries, String modid, String originalMod) {
        super(packOutput, registries, modid, originalMod, id);
    }

    private void wood_variants(RecipeOutput consumer, String mat, Block log, Block fence, Block slab, Block stripped_log)
    {
