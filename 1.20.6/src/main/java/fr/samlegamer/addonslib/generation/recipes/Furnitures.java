...
class Furnitures extends AbstractType {
    ...
    public Furnitures(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> registries, String modid, String originalMod) {
        super(packOutput, registries, modid, originalMod, id);
    }

    private void wood_variants(RecipeOutput consumer, String mat, Block log, Block slab, Block fence, boolean isStripped)
    {
