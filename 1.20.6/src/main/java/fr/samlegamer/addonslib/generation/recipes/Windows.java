...
class Windows extends AbstractType {
    ...
    public Windows(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> registries, String modid, String originalMod) {
        super(packOutput, registries, modid, originalMod, id);
    }

    private void wood_variants(RecipeOutput consumer, String mat, Block log, Block planks, Block slab, Block trapdoor, Block stripped_log)
    {
