...
public abstract class RecipesUtils extends RecipeProvider
{
    ...
    public DoubleObject<RecipeBuilder, ResourceLocation> doubleObjectShapeless(ItemLike planks, ItemLike result, int count, ItemLike firstItem, int required, String group)
    {
        ...
        ShapelessRecipeBuilder shapelessRecipeBuilder = ShapelessRecipeBuilder.shapeless(result, count)
                        ...
                        .group(group)
                        .unlockedBy(_getHasName(planks), _has(planks));
    ...
    public DoubleObject<RecipeBuilder, ResourceLocation> doubleObjectShapedWithItems(ItemLike planks, String[] pattern, ItemLike result, int count, String group, ItemLike... items)
    {
        ...
        shapedRecipeJsonBuilder.group(group).unlockedBy(_getHasName(planks), _has(planks));
    ...
    public DoubleObject<RecipeBuilder, String> doubleObjectStonecutter(ItemLike result, ItemLike firstItem)
    {
        ...
        SingleItemRecipeBuilder builder = SingleItemRecipeBuilder.stonecutting(Ingredient.of(firstItem), result)
                .unlockedBy(_getHasName(firstItem), _has(firstItem));
        return new DoubleObject<>(builder, recipeId);
    }

    private static String _getHasName(ItemLike item) {
        return "has_" + Finder.getIdOfItem(item.asItem());
    }

    private static InventoryChangeTrigger.TriggerInstance _has(ItemLike $$0) {
        return _inventoryTrigger(net.minecraft.advancements.critereon.ItemPredicate.Builder.item().of(new ItemLike[]{$$0}).build());
    }

    private static InventoryChangeTrigger.TriggerInstance _inventoryTrigger(ItemPredicate... $$0) {
