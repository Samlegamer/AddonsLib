...
public abstract class McwBlockTags extends FabricTagProvider.BlockTagProvider implements ITag
{
    ...
    /**
     * Crée une TagKey pour un block à partir d'un nom de tag
     * @param modidTagName Nom du tag au format "namespace:path" (ex: "minecraft:mineable/axe")
     * @return TagKey pour le block
     */
