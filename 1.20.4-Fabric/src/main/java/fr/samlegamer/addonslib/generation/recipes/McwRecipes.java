...
public abstract class McwRecipes extends FabricRecipeProvider {
    ...
    public McwRecipes(FabricDataOutput dataGenerator) {
        super(dataGenerator);
    }

    private void makeRecipesWood(McwBlockIdBase mcwBlockIdBase, RecipeExporter output, String modid, String originalMod, List<String> MAT, List<McwWoodMat<Block>> woodMats)
    {
    ...
    private void makeRecipesStone(McwBlockIdBase mcwBlockIdBase, RecipeExporter output, String modid, String originalMod, List<String> MAT, List<McwStoneMat<Block>> stoneMats)
    {
        for(BlockId blockId : mcwBlockIdBase.blocks())
        {
            for(RecipesBase recipeBase : blockId.recipes())
    ...
    protected void registerMcwWood(RecipeExporter output, String modid, String originalMod, List<String> MAT, List<McwWoodMat<Block>> woodMats, ModType... modType)
    {
    ...
    protected void registerMcwStone(RecipeExporter output, String modid, String originalMod, List<String> MAT, List<McwStoneMat<Block>> stoneMats, ModType... modType)
    {
        for(ModType mod : modType)
        {
    ...
    protected void registerMcwHedge(RecipeExporter output, String modid, String originalMod, List<String> MAT, List<Block> blockLeave)
    {
    ...
    public void registerAllMcwWood(RecipeExporter output, String modid, String originalMod, List<String> MAT, List<McwWoodMat<Block>> woodMats)
    {
        registerMcwWood(output, modid, originalMod, MAT, woodMats, Registration.getAllModTypeWood());
    }

    public void registerAllMcwStone(RecipeExporter output, String modid, String originalMod, List<String> MAT, List<McwStoneMat<Block>> stoneMats)
    {
        registerMcwStone(output, modid, originalMod, MAT, stoneMats, Registration.getAllModTypeStone());
    }


    protected void recipeStonecutter(RecipeExporter exporter, ItemConvertible result, ItemConvertible firstItem, String originalMod, String mcwModid)
    {
    ...
    protected void recipeShapedWith4Items(RecipeExporter exporter, ItemConvertible planks, String[] pattern, ItemConvertible result, int count, ItemConvertible firstItem, ItemConvertible secondItem, ItemConvertible thirdItem, ItemConvertible fourItem, String group, String originalMod, String mcwModid)
    {
        var recipeExporter = withConditions(exporter, DefaultResourceConditions.allModsLoaded(originalMod, mcwModid));
    ...
    protected void recipeShapedWith3Items(RecipeExporter exporter, ItemConvertible planks, String[] pattern, ItemConvertible result, int count, ItemConvertible firstItem, ItemConvertible secondItem, ItemConvertible thirdItem, String group, String originalMod, String mcwModid)
    {
        var recipeExporter = withConditions(exporter, DefaultResourceConditions.allModsLoaded(originalMod, mcwModid));
        ShapedRecipeJsonBuilder shapedRecipeJsonBuilder;
    ...
    protected void recipeShapedWith2Items(RecipeExporter exporter, ItemConvertible planks, String[] pattern, ItemConvertible result, int count, ItemConvertible firstItem, ItemConvertible secondItem, String group, String originalMod, String mcwModid)
    {
        var recipeExporter = withConditions(exporter, DefaultResourceConditions.allModsLoaded(originalMod, mcwModid));
        ShapedRecipeJsonBuilder shapedRecipeJsonBuilder;
    ...
    protected void recipeShapedWith1Item(RecipeExporter exporter, ItemConvertible planks, String[] pattern, ItemConvertible result, int count, ItemConvertible firstItem, String group, String originalMod, String mcwModid)
    {
        var recipeExporter = withConditions(exporter, DefaultResourceConditions.allModsLoaded(originalMod, mcwModid));
        ShapedRecipeJsonBuilder shapedRecipeJsonBuilder;
        if(pattern.length == 3)
    ...
    protected void recipeShapelessWith1ItemRecycle(RecipeExporter exporter, ItemConvertible planks, ItemConvertible result, int count, ItemConvertible firstItem, int required, String group, String originalMod, String mcwModid)
    {
        var recipeExporter = withConditions(exporter, DefaultResourceConditions.allModsLoaded(originalMod, mcwModid));
    ...
    protected void recipeShapelessWith1Item(RecipeExporter exporter, ItemConvertible planks, ItemConvertible result, int count, ItemConvertible firstItem, int required, String group, String originalMod, String mcwModid)
    {
        var recipeExporter = withConditions(exporter, DefaultResourceConditions.allModsLoaded(originalMod, mcwModid));
        ShapelessRecipeJsonBuilder shapelessRecipeJsonBuilder =
                ShapelessRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, result, count)
        ...
        shapelessRecipeJsonBuilder.offerTo(recipeExporter, result.asItem().toString());
    }
}
