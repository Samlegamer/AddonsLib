...
public class McwProperties
{
    ...
    {
        return AbstractBlock.Settings.of(Material.WOOD).strength(2.0F, 2.3F).sounds(BlockSoundGroup.WOOD);
    }

    private static AbstractBlock.Settings getStairsStoneProperties()
    {
        return AbstractBlock.Settings.of(Material.STONE).strength(2.0F, 2.3F).sounds(BlockSoundGroup.STONE);
    }

    private static AbstractBlock.Settings getDoorsJapWoodProperties()
    {
        return AbstractBlock.Settings.of(Material.WOOD).nonOpaque().strength(1.5F, 1.0F).sounds(BlockSoundGroup.SCAFFOLDING);
    }
    ...
    {
        return AbstractBlock.Settings.of(Material.WOOD).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD).nonOpaque();
    }
    ...
    {
        return AbstractBlock.Settings.of(Material.STONE).strength(1.5F, 3.0F).sounds(BlockSoundGroup.STONE).requiresTool();
    }
    ...
    {
        return AbstractBlock.Settings.of(Material.WOOD).sounds(BlockSoundGroup.WOOD).strength(0.6F, 1.2F);
    }
    ...
    {
        return AbstractBlock.Settings.of(Material.WOOD).strength(2.0F, 2.3F);
    }
