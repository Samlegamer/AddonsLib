...
public class Fences
{
	...
	private static AbstractBlock.Properties leaves = AbstractBlock.Properties.copy(Blocks.OAK_LEAVES);
	private static AbstractBlock.Properties stone = AbstractBlock.Properties.copy(Blocks.CUT_SANDSTONE);
	...
	@Deprecated
	public Fences(AbstractBlock.Properties wood, AbstractBlock.Properties leaves, AbstractBlock.Properties stone)
	{
		Fences.wood=wood;
		Fences.leaves=leaves;
		Fences.stone=stone;
	}
