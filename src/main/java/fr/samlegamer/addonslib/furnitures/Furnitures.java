			...
			{				
				try {
				    ...
				    else
				    {
						...
						cherry_counter = createBlockWoodOpti(i+"_counter", new StairsBlock(()->Blocks.OAK_LOG.defaultBlockState(), WOOD), tab);
						cherry_drawer_counter = createBlockWoodOpti(i+"_drawer_counter", new StairsBlock(()->Blocks.OAK_LOG.defaultBlockState(), WOOD), tab);
						cherry_double_drawer_counter = createBlockWoodOpti(i+"_double_drawer_counter", new StairsBlock(()->Blocks.OAK_LOG.defaultBlockState(), WOOD), tab);
						cherry_cupboard_counter = createBlockWoodOpti(i+"_cupboard_counter", new StairsBlock(()->Blocks.OAK_LOG.defaultBlockState(), WOOD), tab);
						...
						stripped_cherry_counter = createBlockWoodOpti("stripped_"+i+"_counter", new StairsBlock(()->Blocks.OAK_LOG.defaultBlockState(), WOOD), tab);
						stripped_cherry_drawer_counter = createBlockWoodOpti("stripped_"+i+"_drawer_counter", new StairsBlock(()->Blocks.OAK_LOG.defaultBlockState(), WOOD), tab);
						stripped_cherry_double_drawer_counter = createBlockWoodOpti("stripped_"+i+"_double_drawer_counter", new StairsBlock(()->Blocks.OAK_LOG.defaultBlockState(), WOOD), tab);
						stripped_cherry_cupboard_counter = createBlockWoodOpti("stripped_"+i+"_cupboard_counter", new StairsBlock(()->Blocks.OAK_LOG.defaultBlockState(), WOOD), tab);
						cherry_kitchen_cabinet = createBlockWoodOpti(i+"_kitchen_cabinet", new StairsBlock(()->Blocks.OAK_LOG.defaultBlockState(), WOOD), tab);
						cherry_double_kitchen_cabinet = createBlockWoodOpti(i+"_double_kitchen_cabinet", new StairsBlock(()->Blocks.OAK_LOG.defaultBlockState(), WOOD), tab);
						cherry_glass_kitchen_cabinet = createBlockWoodOpti(i+"_glass_kitchen_cabinet", new StairsBlock(()->Blocks.OAK_LOG.defaultBlockState(), WOOD), tab);
						stripped_cherry_kitchen_cabinet = createBlockWoodOpti("stripped_"+i+"_kitchen_cabinet", new StairsBlock(()->Blocks.OAK_LOG.defaultBlockState(), WOOD), tab);
						stripped_cherry_double_kitchen_cabinet = createBlockWoodOpti("stripped_"+i+"_double_kitchen_cabinet", new StairsBlock(()->Blocks.OAK_LOG.defaultBlockState(), WOOD), tab);
						stripped_cherry_glass_kitchen_cabinet = createBlockWoodOpti("stripped_"+i+"_glass_kitchen_cabinet", new StairsBlock(()->Blocks.OAK_LOG.defaultBlockState(), WOOD), tab);
				    }
				} catch (Exception e) {
				    e.printStackTrace();
				}
